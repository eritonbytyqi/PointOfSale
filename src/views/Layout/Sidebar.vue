...
<div class="w-64 min-h-screen bg-gradient-to-r from-blue-100 to-blue-10 fixed top-0 left-0">
    ...
    <ul class="space-y-4 mt-10">
      <li>
        <RouterLink :to="{name: 'home'}" class="flex items-center space-x-3 py-2 px-3 text-black rounded-md hover:text-blue-600">
      ...
      <li class="relative">
        ...
        <ul v-show="isOpen" class="mt-1 space-y-1 border-2 border-gray-200 rounded-md pt-2">
          ...
          <li>
            <RouterLink :to="{ name: 'pending-appointments' }" class="flex items-center space-x-3 py-2 px-3 text-black rounded-md hover:text-blue-600">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
      <circle cx="12" cy="12" r="9" stroke="orange" stroke-width="1.5" fill="none"/>
      <path d="M12 3a9 9 0 0 1 0 18" stroke="orange" stroke-width="1.5" fill="orange"/>
    </svg>
